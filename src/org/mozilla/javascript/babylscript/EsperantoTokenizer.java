...
public class EsperantoTokenizer extends BabylGenericTokenizer
{
    public EsperantoTokenizer(ParserErrorReportingBase p, TokenCharStream in, TokenStream ts)
    {
        super(p, 
                in, 
                ts, 
                new BabylTokenizer.DecimalNumberReader(','),
                TranslatedNameBindings.getKeywordMap("eo"));
    }
