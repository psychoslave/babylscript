...
{
    public ChineseTokenizer(Parser p, TokenCharStream in, TokenStream ts)
    {
        super(p, 
                in, 
                ts, 
                new BabylTokenizer.DecimalNumberReader(),
                ResourceBundle.getBundle("org.mozilla.javascript.babylscript.resources.Keywords", new Locale("zh")));
    }
